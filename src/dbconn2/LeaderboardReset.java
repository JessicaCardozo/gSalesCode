...
public class LeaderboardReset {
	...
	public void resetLeaderboardPoints(String docName, String viewName) throws Exception{		
		...
		for(ViewRow row : result){
			...
			try{				
				...
				errorMsg = "Leaderboard points for User "+row.key()+" could not be reset.";			
				errorLog.writeError(bucket, "customer", "Leaderboard Reset", errorMsg);
				continue;
			}
	...
	public static void main(String[] args){
		...
		try{
			...
			String dataBucketName = prop.getProperty("BUCKET");
			...
			bucket = dbOp.getBucket(dbServer, dataBucketName, prop);
