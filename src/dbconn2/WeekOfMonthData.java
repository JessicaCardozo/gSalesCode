...
public class WeekOfMonthData {
	...
	/*This method calculates the week of month points and stores it in the customer document*/
	public void getWeekOfMonthData(String docName, String viewName) throws Exception{
		...
		for(ViewRow row : result){			
			...
			try{
				...
				errorMsg = "Week of Month Points for proposal id "+proposalId+" could not be updated.";
				errorLog.writeError(bucket, "customer", "Week Of Month Data", errorMsg);
				continue;
			}
	...
	/*This method updates the Customer document with the week of the month score*/
	...
	public static void main(String[] args){
		...
		System.out.println("Week Of Month Data");
		...
		try{
			...
			if (bucket==null){
				...
				//errorLog.writeError(bucket, "customer", "Week Of Month", errorMsg);				
				System.exit(-1);
			}
